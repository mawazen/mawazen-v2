      ...
      if (
        ...
        setMessages((prev) => [
          ...prev,
          {
            role: "assistant",
            content:
              "لا يمكنك استخدام المساعد حالياً لأن اشتراكك الشهري غير فعّال. يمكنك الانتقال إلى صفحة المدفوعات لتجديد الاشتراك.",
          },
        ]);
        setIsLoading(false);
        // إزالة التوجيه التلقائي - دع المستخدم يقرر بنفسه
        return;
      }
